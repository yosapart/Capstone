...
// Mock blocks based on standard realistic values
const blocks = [
  ...
  { block_id: 3, step_order: 3, type: 'process', name: 'Sewing', cost_per_unit: 38, electricity_per_unit: 5, people: 50, cost_per_person: 300, duration: 15 },
