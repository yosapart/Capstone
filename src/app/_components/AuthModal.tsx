    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          <button 
            onClick={onClose}
            className="absolute top-5 right-5 text-gray-400 hover:text-red-500 hover:bg-gray-500/10 hover:rotate-90 rounded-full transition-all duration-300 z-50 p-2"
          >
