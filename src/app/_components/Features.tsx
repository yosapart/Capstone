...
export function Features(){
    ...
    return(
        <div id="features" className='flex flex-col w-full max-w-7xl mx-auto my-[10rem] px-6 lg:px-12 gap-[8rem] scroll-mt-[130px]'>
            ...
            >
                <div className='w-full md:w-[45%]'>
                    <h1 className='mb-[1.5rem] font-bold text-4xl lg:text-5xl max-w-[30rem] leading-tight text-gray-900 tracking-tight'> 
                        Visualize Your Factory Layout with Precision
                    </h1>
                    <p className='text-lg lg:text-xl max-w-[28rem] text-gray-500 leading-relaxed font-medium'>
                        Design machine placements and workstations optimized for your specific space to achieve maximum operational efficiency.
                    </p>
                </div>

                <div className='w-full md:w-[55%] aspect-video bg-gray-50 rounded-[2rem] overflow-hidden shadow-2xl relative border border-gray-200 group'>
            ...
            <motion.section 
                ...
                viewport={{ once: true, margin: "-100px" }}
                variants={staggerVariants}
                className='flex flex-col md:flex-row-reverse items-center justify-between gap-12 mt-[2rem] w-full'
            >
            ...
            <motion.section 
                ...
                viewport={{ once: true, margin: "-100px" }}
                variants={staggerVariants}
                className='flex flex-col md:flex-row items-center justify-between gap-12 mt-[2rem] w-full'
            >
                <div className='w-full md:w-[45%]'>
                    <h1 className='mb-[1.5rem] font-bold text-4xl lg:text-5xl max-w-[30rem] leading-tight text-gray-900 tracking-tight'> 
