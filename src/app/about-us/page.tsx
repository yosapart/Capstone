    ...
    return (
      <>
        ...
        <section ref={mission.ref} className="max-w-4xl mx-auto py-14 sm:py-20 px-6 text-center" style={fadeStyle(mission.visible)}>
          <span className="inline-block mb-4 text-xs font-semibold uppercase tracking-widest text-[#5d88bd] bg-[#5d88bd]/10 px-3 py-1 rounded-full">
            Our Mission
          </span>
        ...
        <section ref={valuesRef.ref} className="bg-gray-50 py-14 sm:py-20 px-6 text-center" style={fadeStyle(valuesRef.visible, "0.1s")}>
          <div className="max-w-5xl mx-auto">
            <p className="text-center text-xs font-semibold uppercase tracking-widest text-[#5d88bd] mb-2">What We Stand For</p>
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 text-center mb-8 sm:mb-12">Our Core Values</h2>
            ...
            {team.map((m, i) => (
              <div key={m.name} className="w-1/2 md:w-1/4 flex flex-col items-center text-center group" style={{ animationDelay: `${i * 100}ms` }}>
                  {m.avatar ? (
                    ...
                    <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gray-900 text-white flex items-center justify-center text-lg sm:text-xl font-bold mb-3 sm:mb-4
                                  group-hover:bg-[#5d88bd] transition-colors duration-300 shadow-md">
                    </div>
                  )}
